...
class Index extends \Magento\Backend\App\Action
{
	...
	public function execute()
	{
		...
		if ($params && $params['email']) {
			...
			$body = "
            <b>Congratulation!</b> Your store has been connected with a custom SMTP successfully. Now you can Save Config and use this connection. \n\n
	            This email was sent via Mageplaza SMTP - https://www.mageplaza.com .\n\n 
	            <ul>
		            <li> Recommend more solutions <a href=\"https://www.mageplaza.com/magento-2-extensions/\">here</a>.</li>
		            <li> <a href=\"https://www.mageplaza.com/magento-2-module-development/\">Magento 2 Devdocs</a>.</li>
		            <li> <a href=\"https://www.mageplaza.com/kb/magento-2-tutorial/\">Magento 2 Tutorials</a>.</li>
	            <ul>
            ";

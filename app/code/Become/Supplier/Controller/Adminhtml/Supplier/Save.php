...
class Save extends \Become\Supplier\Controller\Adminhtml\Action
{
    /**
            ...
            if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath('become/supplier')
                    );
                    $data['image'] = 'become/supplier'.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
